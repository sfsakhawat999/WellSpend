...
enum class Category {
    ...
    Transport, Groceries, Clothing, Health, Entertainment, Utilities, Insurance, Savings, Gifts, Travel, Subscriptions, Work, Pets, Family, Fitness, Beauty, Donations, Investments, Electronics, Hobbies, Others
}
